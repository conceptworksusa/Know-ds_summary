...
if __name__ == "__main__":
    ...
    summarizer = OllamaSummarizer(prompt="provide the natural language representation for the following JSON format into paragraph format and do not lose the any JSON data")
